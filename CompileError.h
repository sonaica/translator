...
class InputNonLvalueObjectError : public CompileError {
  public:
    InputNonLvalueObjectError();

    virtual ~InputNonLvalueObjectError();
};

class ExpectedIntegerLiteral : public CompileError {
  public:
    ExpectedIntegerLiteral();

    virtual ~ExpectedIntegerLiteral();
};

class InvalidArraySize : public CompileError {
  public:
    InvalidArraySize();
...
class InvalidComparison : public CompileError {
  public:
    InvalidComparison();
